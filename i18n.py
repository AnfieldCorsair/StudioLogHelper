...
_RU = {
    ...
    "reveal_current_file": "Показать текущий файл в проводнике",
    "reveal_no_file": "У текущего лога нет существующего файла на диске.",
...
_EN = {
    ...
    "reveal_current_file": "Show current file in file manager",
    "reveal_no_file": "The current log has no existing file on disk.",
